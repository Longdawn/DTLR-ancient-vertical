...
lr_backbone = 1e-10 # TO CHANGEEEE
lr_backbone_names = ['backbone.0']
lr_linear_proj_names = ['reference_points', 'sampling_offsets']
lr_linear_proj_mult = 0.1
ddetr_lr_param = False
batch_size = 1 # I chqnged it
weight_decay = 0.0001
epochs = 64
lr_drop = 11*2
...
## random erasing to leanr implicit language model
truly_random_erasing = True
